...
function StatCounter({ end, suffix, label }) {
  const { ref, display } = useAnimatedCounter(end, 1800, suffix)
  return (
...
function MockupCard({ delay, className, children }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -4, boxShadow: '0 16px 48px -8px rgba(0,0,0,0.14)' }}
      ...
      <div className="container-content relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div style={{ y: contentY }}>
            ...
            <h1 className="text-[clamp(2.6rem,5.5vw,5rem)] font-extrabold text-brand-black leading-[1.04] tracking-tight mb-6">
          ...
          <div className="relative hidden lg:block h-[480px]">
            ...
            {/* Main browser card */}
            <MockupCard delay={0.5} className="absolute top-4 left-4 right-4">
            ...
            {/* Perf card */}
            <MockupCard delay={0.72} className="absolute bottom-28 left-0 w-52">
            ...
            {/* Review card */}
            <MockupCard delay={0.9} className="absolute bottom-8 right-0 w-56">
            ...
            {/* Speed badge */}
            <MockupCard delay={1.05} className="absolute top-8 right-0 w-44">
            ...
            {/* Subtle float animation for whole group */}
            <motion.div
              animate={{ y: [0, -6, 0] }}
