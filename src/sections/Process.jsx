    ...
    <section className="section-pad bg-white">
      <div className="container-content">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-[22px] left-[40px] right-[40px] h-px bg-brand-gray-100 z-0 origin-left overflow-hidden">
            <motion.div
        ...
        <FadeIn delay={0.5}>
          <div className="mt-14 pt-10 border-t border-brand-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a href="/contact"
              className="group inline-flex items-center gap-2 text-sm font-semibold text-brand-black border-b border-brand-black pb-0.5 hover:opacity-60 transition-opacity">
