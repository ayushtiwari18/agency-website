...
function ProjectCard({ project, onClick }) {
  ...
  return (
    <motion.button
      ...
      className="card-base overflow-hidden group text-left w-full cursor-pointer focus-visible:ring-2 focus-visible:ring-brand-black focus-visible:outline-none"
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Real case studies from T&J Creates — e-commerce, custom software, and web projects with outcomes and story." />
